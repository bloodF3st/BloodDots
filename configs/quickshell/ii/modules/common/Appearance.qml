...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3surfaceTint: "#cba6f7"
        property color m3primary: "#cba6f7"
        property color m3onPrimary: "#1e1e2e"
        property color m3primaryContainer: "#45475a"
        property color m3onPrimaryContainer: "#e4d4ff"
        property color m3inversePrimary: "#7d5db0"
        property color m3secondary: "#b4befe"
        property color m3onSecondary: "#1e1e2e"
        property color m3secondaryContainer: "#313244"
        property color m3onSecondaryContainer: "#d4dbff"
        property color m3tertiary: "#f5c2e7"
        property color m3onTertiary: "#1e1e2e"
        property color m3tertiaryContainer: "#45475a"
        property color m3onTertiaryContainer: "#ffd9f0"
        property color m3error: "#f38ba8"
        property color m3onError: "#1e1e2e"
        property color m3errorContainer: "#311324"
        property color m3onErrorContainer: "#ffb3c6"
        property color m3primaryFixed: "#e4d4ff"
        property color m3primaryFixedDim: "#cba6f7"
        property color m3onPrimaryFixed: "#180030"
        property color m3onPrimaryFixedVariant: "#583a7e"
        property color m3secondaryFixed: "#d4dbff"
        property color m3secondaryFixedDim: "#b4befe"
        property color m3onSecondaryFixed: "#010040"
        property color m3onSecondaryFixedVariant: "#424678"
        property color m3tertiaryFixed: "#ffd9f0"
        property color m3tertiaryFixedDim: "#f5c2e7"
        property color m3onTertiaryFixed: "#280018"
        property color m3onTertiaryFixedVariant: "#693050"
        property color m3success: "#a6e3a1"
        property color m3onSuccess: "#0d2b1d"
        property color m3successContainer: "#1a4530"
        property color m3onSuccessContainer: "#c5ffd0"

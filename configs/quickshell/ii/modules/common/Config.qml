        ...
        JsonAdapter {
            ...
            property JsonObject appearance: JsonObject {
                ...
                property JsonObject fonts: JsonObject {
                    property string main: "SF Pro Text"
                    property string numbers: "SF Pro Text"
                    property string title: "SF Pro Text"
                    property string iconNerd: "JetBrains Mono NF"
                    property string monospace: "JetBrains Mono NF"
                    property string reading: "SF Pro Text"
                    property string expressive: "SF Pro Text"
                }
